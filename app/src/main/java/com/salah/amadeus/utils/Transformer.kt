package com.salah.amadeus.utils

import com.salah.amadeus.data.local.entity.*
import com.salah.amadeus.models.*
...
object Transformer {
    ...
    private fun convertCoordModelToCoordEntity(coord: Coord): CoordEntity {
